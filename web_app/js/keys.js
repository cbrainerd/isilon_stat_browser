var keyDict = {
  "keys": {
    ...
    "node.ifs.heat.deadlocked.noresolve": {
      "sub": "Node", 
      "super": "File System", 
      "aggregation_type": "custom", 
      ...
      "real_name": null, 
      "subsub": "File Heat", 
      "key": "node.ifs.heat.deadlocked.noresolve", 
      "units": "none", 
      "scope": "node", 
      "type": "stats_heat_list_noresolve", 
      "policies": [
        {
          "interval": 10, 
          "persistent": false, 
      ...
      "description": "Hottest /ifs entities for deadlocked events on this node with unresolved lins"
    }, 
    ...
    "node.ifs.heat.blocked.noresolve": {
      "sub": "Node", 
      "super": "File System", 
      "aggregation_type": "custom", 
      ...
      "real_name": null, 
      "subsub": "File Heat", 
      "key": "node.ifs.heat.blocked.noresolve", 
      "units": "none", 
      "scope": "node", 
      "type": "stats_heat_list_noresolve", 
      "policies": [
      ...
      "description": "Hottest /ifs entities for blocked events on this node with unresolved lins"
    }, 
    ...
    "node.sensor.volt.volts.vdcps2": {
      ...
      "subsub": null, 
      "key": "node.sensor.volt.volts.vdcps2", 
      "units": "volts", 
      "scope": "node", 
      "type": "double", 
      "policies": null, 
    ...
    "node.proc.stats": {
      ...
      "units": "none", 
      "scope": "node", 
      "type": "stats_proc_stats", 
      "policies": null, 
      "description": "Stats for all processes"
    }, 
    "node.sensor.volt.volts.vdcps1": {
      "sub": "Voltage", 
      "super": "Sensors", 
      "aggregation_type": "average", 
      "base_name": null, 
      ...
      "subsub": null, 
      "key": "node.sensor.volt.volts.vdcps1", 
      "units": "volts", 
      "scope": "node", 
      "type": "double", 
      "policies": null, 
    ...
    "node.ifs.heat.setattr.noresolve": {
      "sub": "Node", 
      "super": "File System", 
      "aggregation_type": "custom", 
      ...
      "real_name": null, 
      "subsub": "File Heat", 
      "key": "node.ifs.heat.setattr.noresolve", 
      "units": "none", 
      "scope": "node", 
      "type": "stats_heat_list_noresolve", 
      "policies": [
      ...
      "description": "Hottest /ifs entities for setattr events on this node with unresolved lins"
    }, 
    ...
    "node.ifs.heat.contended.noresolve": {
      "sub": "Node", 
      "super": "File System", 
      "aggregation_type": "custom", 
      ...
      "real_name": null, 
      "subsub": "File Heat", 
      "key": "node.ifs.heat.contended.noresolve", 
      "units": "none", 
      "scope": "node", 
      "type": "stats_heat_list_noresolve", 
      "policies": [
      ...
      "description": "Hottest /ifs entities for contended events on this node with unresolved lins"
    }, 
    ...
    "node.sensor.misc.data.PwrOn1": {
      ...
      "subsub": null, 
      "key": "node.sensor.misc.data.PwrOn1", 
      "units": "none", 
      "scope": "node", 
      "type": "int32", 
      "policies": null, 
    ...
    "node.ifs.heat.write.noresolve": {
      ...
      "real_name": null, 
      "subsub": "File Heat", 
      "key": "node.ifs.heat.write.noresolve", 
      "units": "none", 
      "scope": "node", 
      "type": "stats_heat_list_noresolve", 
      "policies": [
      ...
      "description": "Hottest /ifs entities for write events on this node with unresolved lins"
    }, 
    ...
    "node.ifs.heat.getattr.noresolve": {
      "sub": "Node", 
      "super": "File System", 
      "aggregation_type": "custom", 
      ...
      "real_name": null, 
      "subsub": "File Heat", 
      "key": "node.ifs.heat.getattr.noresolve", 
      "units": "none", 
      "scope": "node", 
      "type": "stats_heat_list_noresolve", 
      "policies": [
      ...
      "description": "Hottest /ifs entities for getattr events on this node with unresolved lins"
    }, 
    "node.ifs.vop.stats": {
      "sub": "Node", 
      "super": "File System", 
    ...
    "node.sensor.misc.data.PwrOk1": {
      ...
      "subsub": null, 
      "key": "node.sensor.misc.data.PwrOk1", 
      "units": "none", 
      "scope": "node", 
      "type": "int32", 
      "policies": null, 
    ...
    "node.sensor.misc.data.PwrOk2": {
      ...
      "subsub": null, 
      "key": "node.sensor.misc.data.PwrOk2", 
      "units": "none", 
      "scope": "node", 
      "type": "int32", 
      "policies": null, 
    ...
    "node.ifs.heat.lock.noresolve": {
      ...
      "real_name": null, 
      "subsub": "File Heat", 
      "key": "node.ifs.heat.lock.noresolve", 
      "units": "none", 
      "scope": "node", 
      "type": "stats_heat_list_noresolve", 
      "policies": [
      ...
      "description": "Hottest /ifs entities for lock events on this node with unresolved lins"
    }, 
    ...
    "node.ifs.heat.read.noresolve": {
      ...
      "real_name": null, 
      "subsub": "File Heat", 
      "key": "node.ifs.heat.read.noresolve", 
      "units": "none", 
      "scope": "node", 
      "type": "stats_heat_list_noresolve", 
      "policies": [
      ...
      "description": "Hottest /ifs entities for read events on this node with unresolved lins"
    }, 
    ...
    "node.ifs.journal.stats": {
      ...
      "real_name": null, 
      "subsub": "Other", 
      "key": "node.ifs.journal.stats", 
      "units": "none", 
      "scope": "node", 
      "type": "stats_journal_stats", 
      "policies": null, 
    ...
    "node.ifs.heat.rename.noresolve": {
      "sub": "Node", 
      "super": "File System", 
      "aggregation_type": "custom", 
      "base_name": "node.ifs.heat.rename", 
      ...
      "real_name": null, 
      "subsub": "File Heat", 
      "key": "node.ifs.heat.rename.noresolve", 
      "units": "none", 
      "scope": "node", 
      "type": "stats_heat_list_noresolve", 
      "policies": [
      ...
      "description": "Hottest /ifs entities for rename events on this node with unresolved lins"
    }, 
    ...
    "node.ifs.coalescer.stats": {
      ...
      "real_name": null, 
      "subsub": "Other", 
      "key": "node.ifs.coalescer.stats", 
      "units": "none", 
      "scope": "node", 
      "type": "stats_coal_stats", 
      "policies": null, 
    ...
    "node.workload.category.N": {
      ...
      "real_name": null, 
      "subsub": null, 
      "key": "node.workload.category.N", 
      "units": "none", 
      "scope": "node", 
      "type": "stats_workload_category_stats", 
      "policies": [
        {
          "interval": 5, 
          "persistent": false, 
      ...
      "description": "List of workloads for category N"
    }, 
    ...
    "node.ifs.heat.lookup.noresolve": {
      "sub": "Node", 
      "super": "File System", 
      "aggregation_type": "custom", 
      "base_name": "node.ifs.heat.lookup", 
      ...
      "real_name": null, 
      "subsub": "File Heat", 
      "key": "node.ifs.heat.lookup.noresolve", 
      "units": "none", 
      "scope": "node", 
      "type": "stats_heat_list_noresolve", 
      "policies": [
      ...
      "description": "Hottest /ifs entities for lookup events on this node with unresolved lins"
    }, 
    ...
    "node.sensor.misc.data.PwrOn2": {
      ...
      "subsub": null, 
      "key": "node.sensor.misc.data.PwrOn2", 
      "units": "none", 
      "scope": "node", 
      "type": "int32", 
      "policies": null, 
    ...
    "node.ifs.heat.link.noresolve": {
      ...
      "real_name": null, 
      "subsub": "File Heat", 
      "key": "node.ifs.heat.link.noresolve", 
      "units": "none", 
      "scope": "node", 
      "type": "stats_heat_list_noresolve", 
      "policies": [
      ...
      "description": "Hottest /ifs entities for link events on this node with unresolved lins"
    }, 
    ...
    "node.ifs.heat.unlink.noresolve": {
      "sub": "Node", 
      "super": "File System", 
      "aggregation_type": "custom", 
      "base_name": "node.ifs.heat.unlink", 
      ...
      "real_name": null, 
      "subsub": "File Heat", 
      "key": "node.ifs.heat.unlink.noresolve", 
      "units": "none", 
      "scope": "node", 
      "type": "stats_heat_list_noresolve", 
      "policies": [
      ...
      "description": "Hottest /ifs entities for unlink events on this node with unresolved lins"
    }, 
    ...
    "node.ifs.rbm.stats": {
      ...
      "real_name": null, 
      "subsub": "Other", 
      "key": "node.ifs.rbm.stats", 
      "units": "none", 
      "scope": "node", 
      "type": "stats_rbm_stats", 
      "policies": null, 
  ...
  "mappings": {
    "keys": {
      ...
      "node.ifs.vop.stats": "key_a60cb22340c0939af048af0984410769", 
      ...
      "node.sensor.volt.volts.vdcps2": "key_e7774fb09cd79ea89580f4826e48767f", 
      ...
      "node.ifs.heat.blocked.noresolve": "key_05d24232e57489616586aaaf9474b97c", 
      ...
      "node.sensor.misc.data.PwrOn2": "key_a8fc0b6ee2cdb9e43ce7cc08b807276e", 
      "node.sensor.misc.data.PwrOn1": "key_8d5fa8799c6f29cd5ab77eb41c8f0955", 
      ...
      "node.ifs.heat.getattr.noresolve": "key_059310b7e4763b3236de458ad979aeec", 
      ...
      "node.ifs.heat.deadlocked.noresolve": "key_cce3df9140efdccc4438592b612375e7", 
      ...
      "node.sensor.misc.data.PwrOk2": "key_96e33327bf7d05eac841596eda26a7a7", 
      ...
      "node.ifs.heat.read.noresolve": "key_75cbf367e1eacfb9072146a0b432cb12", 
      ...
      "node.ifs.heat.lock.noresolve": "key_55ad2779c4cc7e41254eecec9a307a26", 
      ...
      "node.workload.category.N": "key_4563cd8515accaaf74828b5ffdde6a98", 
      ...
      "node.ifs.vm.stats": "key_57d88203e62058acb35de2782fcc2de4", 
      ...
      "node.ifs.heat.setattr.noresolve": "key_86ee44813c9a89b0b1c30152de958630", 
      ...
      "node.ifs.heat.rename.noresolve": "key_83d61068714ef267a62f488720767cbd", 
      "node.ifs.heat.lookup.noresolve": "key_91830c9a3f2bbea30b586503f297af7d", 
      ...
      "node.sensor.misc.data.PwrOk1": "key_b330396a476946aa50f60bdc0f69660f", 
      ...
      "node.ifs.coalescer.stats": "key_8a43ef82d6438995170722399a3a80ee", 
      ...
      "node.ifs.journal.stats": "key_666b26e5121099ab4881522d1ed99eda", 
      "node.proc.stats": "key_ca46377a95da1af3dd2d178fe8c5fdb0", 
      ...
      "node.ifs.heat.unlink.noresolve": "key_cf1937ad6a939631b85eb55a56a041ad", 
      ...
      "node.sensor.volt.volts.vdcps1": "key_cede49da1b20f27e2940b54e98f996c3", 
      ...
      "node.ifs.heat.link.noresolve": "key_c00859bd2209cf5ff01f9d25f766737a", 
      ...
      "node.ifs.heat.contended.noresolve": "key_3c6ecdbfe76a639495eb7f3b679a4024", 
      ...
      "node.ifs.heat.write.noresolve": "key_2f366789c9913627ce9acab2384a880a", 
      ...
      "node.ifs.rbm.stats": "key_6406a3545ff3e9ccd8e5bdc7cf69f7fe", 
